...
Outputs:
  models_real/flood_static_research_model.pkl
  models_real/flood_static_research_metadata.json
...
def save_best_model(best: dict, feature_list: list, df: pd.DataFrame,
    ...
    pkl_path = MODELS_DIR / "flood_static_v2_research_model.pkl"
    ...
    metadata = {
        "schema_version": "v3",
        "model_version": "flood_static_v2_research",
    ...
    meta_path = MODELS_DIR / "flood_static_v2_research_metadata.json"
